...
# Entry field
entry = tkinter.Entry(root, font=("arial", 20, "bold"), bg="white", fg="black", bd=20, width=32)
...
for i in button_list:
    # Buttons
    button = tkinter.Button(root, width=5, height=2, bd=5, text=i, bg="light grey", fg="black",
